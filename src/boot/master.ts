...
function greet() {
	if (!program.quiet) {
		...
		console.log(' ____  _____  __    ____  _   _  ____  _  _ ');
		console.log('(  _ \\(  _  )(  )  (  _ \\( )_( )(_  _)( \\( )');
		console.log(' )(_) ))(_)(  )(__  )___/ ) _ (  _)(_  )  ( ');
		console.log('(____/(_____)(____)(__)  (_) (_)(____)(_)\\_)');
		console.log(chalk.gray(v));
		//#endregion

		console.log(' Welcome to Dolphin!');
		console.log(chalk.keyword('orange')(' Dolphin is open-source software. https://github.com/mei23/dolphin'));

		console.log('');
		console.log(chalk`< ${os.hostname()} {gray (PID: ${process.pid.toString()})} >`);
	}

	bootLogger.info(`Dolphin v${pkg.version}`, null, true);
}
